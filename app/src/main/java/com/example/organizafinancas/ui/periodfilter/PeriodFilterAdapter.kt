...
class PeriodFilterAdapter(
    private val paymentFilterList: List<PaymentMethod> = mutableListOf(),
    private val onItemClick: (PaymentMethod, Int) -> Unit
    ...
    inner class ViewHolder(private val binding: ItemPeriodFilterBinding) :
        ...
        fun bind(paymentFilter: PaymentMethod, isLast: Boolean, position: Int) {
            with(binding) {
